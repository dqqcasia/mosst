...
class SimulConvTransformerModelWav2Vec(ConvTransformerModelWac2Vec):
    ...
    @staticmethod
    def add_args(parser):
        super(SimulConvTransformerModelWav2Vec, SimulConvTransformerModelWav2Vec).add_args(parser)
        parser.add_argument(
            "--train-monotonic-only",
            action="store_true",
            default=False,
...
class SimulConvTransformerCIFModel(ConvTransformerCIFModel):
    ...
    @staticmethod
    def add_args(parser):
        super(SimulConvTransformerCIFModel, SimulConvTransformerCIFModel).add_args(parser)
        parser.add_argument(
            "--train-monotonic-only",
            action="store_true",
            default=False,
...
class SimulConvTransformerModelWav2VecCIF(ConvTransformerModelWac2VecCIF):
    ...
    @staticmethod
    def add_args(parser):
        super(SimulConvTransformerModelWav2VecCIF, SimulConvTransformerModelWav2VecCIF).add_args(parser)
        parser.add_argument(
            "--train-monotonic-only",
            action="store_true",
            default=False,
...
@register_model_architecture(
    "convtransformer_simul_trans_wav2vec_cif", "convtransformer_simul_trans_espnet_wav2vec_cif"
)
